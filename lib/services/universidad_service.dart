...
class UniversidadService {
  ...
  /// Observa una universidad específica por su ID en tiempo real
  ...
  /// Verifica si existe una universidad con el mismo NIT
  static Future<bool> existeNit(String nit, {String? excludeId}) async {
    final snapshot = await _ref.where('nit', isEqualTo: nit).get();
    if (excludeId != null) {
